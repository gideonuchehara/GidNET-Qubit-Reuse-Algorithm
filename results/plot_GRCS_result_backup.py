...
# please run in a command line else, watch out for the maths in legend rendering incorrectly
...
legend_labels = algorithm_labels + depth_labels + [" "] + [r'GidNET Fit: $c \cdot n^3$', r'QNET Fit: $c \cdot n^5$']

plt.legend(prop={'size': 13, 'weight': 'bold'}, handles=legend_handles, labels=legend_labels, loc='upper left', ncol=3, handlelength=3, fontsize=12, frameon=True, borderpad=1, labelspacing=1.2, columnspacing=1.1)
