...
class QubitReuseModified():
    """A qubit reuse via midcircuit measurement transformation pass. This is a modified version of QubitReuse that excludes only TransformationPass for easy comparison with GidNET. 
